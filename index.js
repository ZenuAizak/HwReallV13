...
🌷 KALAU MAU RENAME TARO CREDITS GUA : ᴀʀғᴀɴ☆ */
...
auth: state})
//=================================================//
if (haikal.user && haikal.user.id) haikal.user.jid = jidDecode(haikal.user.id)
...
let buttons = [
{buttonId: `ᴀʀғᴀɴ☆`, buttonText: {displayText: hello}, type: 1},
]
let buttonMessage = {
...
let link = `https://youtube.com/c/HwModsWa857`
let buttons = [
{buttonId: `ᴀʀғᴀɴ☆`, buttonText: {displayText: bye}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let buttons = [
{buttonId: `ᴀʀғᴀɴ`, buttonText: {displayText: 'KASIAN'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `ᴀʀғᴀɴ`, buttonText: {displayText: 'SELAMAT'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
			...
			lolcatjs.fromString(`[Connected] ` + JSON.stringify(haikal.user, null, 2))
		}
